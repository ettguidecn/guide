...
<img :src="$withBase('/ScreenSelectMusic-General.png')" alt="General">
...
<img :src="$withBase('/ScreenSelectMusic-MSD.png')" alt="MSD">
...
<img :src="$withBase('/ScreenSelectMusic-Scores.png')" alt="Scores">

+ Search：搜索特定歌曲，目前只支持英文和数字。输入字符后可以按开始&lt;Start&gt;固定搜索结果、后退&lt;Back&gt;取消搜索以及Delete键重置搜索
<img :src="$withBase('/ScreenSelectMusic-Search.png')" alt="Search">
...
<img :src="$withBase('/ScreenSelectMusic-Profile.png')" alt="Profile">
...
<img :src="$withBase('/ScreenSelectMusic-Goals.png')" alt="Goals">
...
<img :src="$withBase('/ScreenSelectMusic-Tags.png')" alt="Tags">
